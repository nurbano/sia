...
def loss_function(y_true, y_pred, z_mean, z_log_var, epoch_frac):
    ...
    kl_loss = np.mean(kl_loss)*min(1.0, epoch_frac)

    # Pérdida total
    total_loss = reconstruction_loss + kl_loss
    return total_loss, reconstruction_loss, kl_loss,  epoch_frac